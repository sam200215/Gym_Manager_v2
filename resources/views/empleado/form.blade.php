    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" name="fecha_contratacion" class="form-control @error('fecha_contratacion') is-invalid @enderror" 
                   value="{{ old('fecha_contratacion', isset($empleado->fecha_contratacion) ? $empleado->fecha_contratacion->format('Y-m-d') : '') }}" required>
...
<div class="box-footer mt-3">
    <button type="submit" class="btn btn-primary">
        <i class="fa fa-save"></i> {{ isset($empleado) ? __('Actualizar') : __('Guardar') }}
    </button>
</div>