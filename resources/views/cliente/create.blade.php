            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-left">
                        <span class="card-title"><i class="fas fa-user-plus"></i> {{ __('Crear Cliente') }}</span>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="condiciones_medicas" class="form-control @error('condiciones_medicas') is-invalid @enderror">{{ old('condiciones_medicas') }}</textarea>
