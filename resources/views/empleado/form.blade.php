<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="usuario_id" class="form-control @error('usuario_id') is-invalid @enderror" value="{{ old('usuario_id', $empleado?->usuario_id) }}" id="usuario_id" placeholder="Usuario Id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nombre_completo" class="form-control @error('nombre_completo') is-invalid @enderror" value="{{ old('nombre_completo', $empleado?->nombre_completo) }}" id="nombre_completo" placeholder="Nombre Completo">
