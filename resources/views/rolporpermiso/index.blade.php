										...
										<td >{{ $rolporpermiso->permiso_id }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('rolporpermisos.destroy', $rolporpermiso->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('rolporpermisos.show', $rolporpermiso->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('rolporpermisos.edit', $rolporpermiso->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
